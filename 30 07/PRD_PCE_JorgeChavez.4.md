...
- Ofrecer un mapa geoespacial del AIJC (sobre el mapa cuadriculado ya existente) donde se ubique la posición del incidente. La visualización en tiempo real de la posición de las unidades SSEI vía geolocalización GETAC queda fuera del alcance v1 (ver sección 6).
...
| Adopción del mapa geoespacial | 100% de incidentes Alerta II/III con ubicación registrada en el mapa (GPS de la tablet GETAC, con respaldo manual) | Confirmado por Renzo, 2026-07-17; captura por GPS decidida 2026-08-16 |
...
- Mapa geoespacial del AIJC (sobre el mapa cuadriculado existente), con la ubicación del incidente capturada por GPS de la tablet GETAC al registrar el marcador, con ingreso manual de respaldo si el GPS falla o no hay señal (ej. interior de un edificio) — decidido con Renzo, 2026-08-16, en reemplazo del levantamiento/georreferenciación del mapa cuadriculado en papel (ver sección 8).
...
- Geolocalización en tiempo real de las unidades SSEI sobre el mapa vía tablets GETAC — v1 solo captura la ubicación del incidente al momento de registrar el marcador (por GPS de la tablet GETAC, con respaldo manual — ver sección 6); el tracking en vivo de unidades queda para una fase posterior (alcance confirmado con Renzo el 2026-07-17).
- Cálculo de rutas óptimas de acceso o navegación turn-by-turn para las unidades — v1 solo visualiza la ubicación del incidente registrada al marcarlo, no calcula ni sugiere rutas.
...
- **Confirmado (Renzo, 2026-07-17)** — el mapa cuadriculado existente (hoy en papel/PDF) no tiene coordenadas georreferenciables utilizables tal cual; requiere trabajo de levantamiento/georreferenciación en campo antes de usarse como base del mapa geoespacial del PCE. **Resuelto (Renzo, 2026-08-16)**: en vez de levantar el mapa cuadriculado en papel, los marcadores nuevos capturan la posición directamente por GPS de la tablet GETAC (hardware ya pagado, sección 3) al registrarse, con ingreso manual de respaldo si el GPS falla. El levantamiento del mapa cuadriculado en papel en sí no se hace — deja de ser un prerrequisito para registrar marcadores nuevos.
