...
- Registro de activación de emergencia con nivel de Alerta (I/II/III para eventos aeronáuticos; cada una de las otras 3 categorías con su propia escala diferenciada, confirmado que no comparten la escala aeronáutica — Renzo, 2026-07-17; detalle de cada escala aún por definir) y activación diferenciada de miembros de COE y/o PMM según el nivel.
- Registro de la evaluación inicial del Comandante de Incidente (tipo de incidente, magnitud, riesgos secundarios) y transmisión estructurada de ese informe al COE — reemplazo digital del reporte verbal/WhatsApp actual.
