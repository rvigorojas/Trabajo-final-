...
Command") y 9 tests (Vitest + RTL + MSW). El shell de navegación (Opción 1A, tabs inferiores +
acciones flotantes) está decidido pero todavía sin implementar (ítem #2 del `BACKLOG.md`).
